            ...
            child: Column(
              ...
              children: [
                ...
                if (_saleItems.isEmpty)
                  ...
                  ..._saleItems.values.map((item) => _buildCartItem(item, isDispose: false)),
                const SizedBox(height: 16),
            ...
            child: Column(
              ...
              children: [
                ...
                if (_disposeItems.isEmpty)
                  ...
                  ..._disposeItems.values.map((item) => _buildCartItem(item, isDispose: true)),
                const SizedBox(height: 16),
                  ...
                  return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return ListTile(
                        ...
                        subtitle: Text(CurrencyFormat.format(p.sellPrice ?? 0), style: const TextStyle(color: Colors.blue, fontSize: 11)),
