...
import 'package:sapo_clone_app/Providers/product_provider.dart';
import 'package:sapo_clone_app/models/product.dart';
import 'package:sapo_clone_app/services/product_service.dart';
import 'package:sapo_clone_app/services/master_data_service.dart';
import 'package:sapo_clone_app/models/category.dart';
import 'package:sapo_clone_app/models/unit.dart';
              ...
              children: [
                ...
                if (isEdit) ...[
                  ...
                  SizedBox(
                    ...
                    child: OutlinedButton.icon(
                      onPressed: () {
                        // Load detail first to ensure images are available
                        ...
                        showModalBottomSheet(
                          ...
                          builder: (context) => DraggableScrollableSheet(
                           ...
                           // Refresh detail in case main image changed
                           _triggerSearch();
                        });
                      },
                ...
                ElevatedButton(
                  ...
                  onPressed: () async {
                    final payload = {
                      ...
                      'sellPriceOriginal': double.tryParse(sellPriceOriginalController.text),
                    ...
                    try {
                      ...
                      ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text('Failed: $msg'), backgroundColor: Colors.red));
                    }
                  },
