...
class _FinancialReportScreenState extends State<FinancialReportScreen> {
  ...
  void initState() {
    ...
    final userStoreId = auth.user?.storeId;
    if (userStoreId != null && userStoreId > 0) {
      _selectedStoreId = userStoreId;
    } else {
  ...
  Widget _buildFilterSection() {
    final auth = context.read<AuthProvider>();
    final userStoreId = auth.user?.storeId;
    final isStoreLocked = userStoreId != null && userStoreId > 0;
          ...
          DropdownButtonFormField<int>(
            ...
            items: isStoreLocked
                ? [
                    DropdownMenuItem(
                      value: userStoreId,
                      child: Text(auth.user?.fullName != null ? 'Your Assigned Store (#$userStoreId)' : 'Assigned Store', overflow: TextOverflow.ellipsis),
                    ),
                  ]
                : [
